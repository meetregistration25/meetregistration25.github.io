...
let id,password;
   ...
   $('#submit').on('click',function() {
     ...
     if(id == 'gsclub' && password == 'murjomarsaga' ||id == 'str' && password == 'str444' || id == 'gldani' && password == 'chempion777' || id == 'gldani' && password == 'chempion 777'|| id == 'tonusi' && password == 'gioira' || id == 'aqva' && password == 'mari28' || id == 'gori' && password == 'mari27' || id == 'sachkhere' && password == 'auzi' || id == 'black sea' && password == 'blacksea2013' || id == 'gsssporttime' && password == '0023' || id == 'chiatura' && password == 'v@leri' || id == 'hualing' && password == '1919olmp') {
    ...
    function registration() {
        ...
        if ($('#style').val() && $('#distance').val() && $('#swimmerName').val()) {
         $('#clickkk').show();
            ...
            let options;
            let clubs = ['რუსთავი', 'ეს თი ერ', 'ტონუსი', 'ბლექ სი', 'ჯი ეს სი', 'ჯი ეს ეს', 'გლდანი', 'ჰუალინგი', 'არენა', 'თემქა']
